"""Параметры Django-проекта: переменные окружения, деплой, интеграции.

Справочник настроек: https://docs.djangoproject.com/en/5.2/ref/settings/
Чеклист продакшена: https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/
"""
